...
### ELT Steps:
1. **Extract**:
   - Using web scraping techniques, I am extract data from the IMDb website.
   - The data contains information related to top movies, such as title, year, rating, and more.

2. **Load**:
   - The extracted data is temporarily stored in the **staging area** (local folder) in both CSV and JSON formats.
